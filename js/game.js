...
// ======= BEGIN ==================================================================
//  Adapted from DiveIntoHTML5: http://diveintohtml5.info/detect.html#video-formats
//      to support video format detection across browsers
//  Ideal solution would be to add Modernizr.js, in which case delete everything
//    between BEGIN/END markers and replace with single Modernizr call.
//
