...
GameOver.prototype =
{
	Setup: function()
	{
		...
		var background = 	CreateScreenUI(this,0.5,0.5,"gameover_background","background");
		this.titleText = 	CreateTextUI(this,0.5,0.1,"GameOver","bold 40px Arial","center","black");
		
		//Create Button to replay game
		var replayGame =		CreateButtonUI(this,0.3,0.5,"button",this.replayGame.bind(this),1,"background");
		replayGame.addChild(CreateTextUI(this,0,0,"Replay Game","bold 24px Arial","center","black"));
		
		var quitGame =		CreateButtonUI(this,0.7,0.5,"button",this.goToMain.bind(this),1,"background");
